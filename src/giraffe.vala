...
double map_range(double n, double start_min, double start_max, double end_min, double end_max)
	{
	return end_min + ((end_max - end_min) / (start_max - start_min)) * (n - start_min);
	}
double map_range_flip(double n, double start_min, double start_max, double end_min, double end_max)
	{
	double normalised = map_range(n,start_min,start_max,0f,1f);
	return map_range(1-normalised,0f,1f,end_min,end_max);
	}
string nice_double(double d) // Prints doubles to hide roundoff errors
	{
